...
@{
	...
	FunctionsToExport = 'new-pfaVolRdm','get-pfaVolfromRDM','get-pfaConnectionlfromRDM','new-pfaVolRdmSnapshot','get-pfaVolRDMSnapshot','copy-pfaSnapshotToRDM','set-pfaVolRDMCapacity','remove-pfaVolRDM','convert-pfaVolRDMtoVvol'
